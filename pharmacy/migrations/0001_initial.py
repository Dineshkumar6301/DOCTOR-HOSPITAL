    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "type",
                    models.CharField(
                        choices=[("test", "Test"), ("package", "Package")],
                        default="test",
                        max_length=10,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=200, verbose_name="Blood Bank Name"),
                ),
                (
                    "registration_number",
                    models.CharField(
                ...
                (
                    "pin_code",
                    models.CharField(max_length=10, verbose_name="PIN/Zip Code"),
                ),
                (
                    "map_link",
                    models.URLField(blank=True, verbose_name="Google Map Embed Link"),
                ),
                (
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=50,
                        verbose_name="Weekend Hours",
                    ),
                ),
                (
                    "is_24x7",
                    models.BooleanField(default=False, verbose_name="24x7 Service"),
                ),
                (
                    "emergency_service",
                    models.BooleanField(
                        default=False, verbose_name="Emergency Service Available"
                    ),
                ),
                (
                    "mobile_donation_camps",
                    models.BooleanField(
                        default=False, verbose_name="Mobile Donation Camps"
                    ),
                ),
                (
                    "home_collection",
                    models.BooleanField(
                        default=False, verbose_name="Home Collection Service"
                    ),
                ),
                (
                    "appointment_required",
                    models.BooleanField(
                        default=False, verbose_name="Appointment Required"
                    ),
                ),
                (
                    "services",
                    models.JSONField(default=list, verbose_name="Services Available"),
                ),
                (
                    "certifications",
                    models.CharField(
                        blank=True, verbose_name="Certifications & Accreditations"
                    ),
                ),
                (
                    "affiliated_hospitals",
                    models.CharField(blank=True, verbose_name="Affiliated Hospitals"),
                ),
                (
                    "profile_image",
                    models.ImageField(
                ...
                (
                    ...
                    models.CharField(
                        blank=True, verbose_name="Special Instructions/Notes"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity_needed",
                    models.IntegerField(verbose_name="Quantity Needed (Units)"),
                ),
                (
                    "urgency_level",
                    models.CharField(
                ...
                ("medical_reason", models.CharField(verbose_name="Medical Reason")),
                (
                    "doctor_name",
                ...
                (
                    "notes",
                    models.CharField(blank=True, verbose_name="Additional Notes"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "donor_name",
                    models.CharField(max_length=100, verbose_name="Donor Name"),
                ),
                (
                    "donor_phone",
                    models.CharField(max_length=17, verbose_name="Donor Phone"),
                ),
                (
                    "donor_email",
                    models.EmailField(
                ...
                (
                    "donation_count",
                    models.IntegerField(default=0, verbose_name="Total Donations"),
                ),
                (
                    "donor_status",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        blank=True, null=True, upload_to="medicine_categories/"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        through="pharmacy.FavouriteDoctor",
                        to="pharmacy.doctor",
                    ),
                ),
                (
        ...
        migrations.AddField(
            ...
            name="patient",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="pharmacy.patient"
            ),
        ),
        migrations.CreateModel(
            name="Appointment",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("parameters_included", models.CharField()),
                (
                    "sample_type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity",
                    models.IntegerField(default=0, verbose_name="Quantity (Units)"),
                ),
                ("collection_date", models.DateField(verbose_name="Collection Date")),
                (
                    "batch_number",
                    models.CharField(max_length=50, verbose_name="Batch Number"),
                ),
                (
                    "testing_status",
                    models.CharField(
            ...
            options={
                ...
                "unique_together": {
                    ("blood_bank", "blood_group", "component_type", "batch_number")
                },
            },
        ),
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                condition=models.Q(("user", None), _negated=True),
                fields=("user",),
